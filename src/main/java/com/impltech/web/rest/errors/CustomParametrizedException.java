...
public class CustomParametrizedException extends RuntimeException {
    ...
    public CustomParametrizedException(String message, Map<String, String> paramMap) {
        super(message);
        this.message = message;
        this.paramMap.putAll(paramMap);
    }

    public ParametrizedErrorVM getErrorVM() {
        return new ParametrizedErrorVM(message, paramMap);
    }
}
